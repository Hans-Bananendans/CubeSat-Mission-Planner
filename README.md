...
### Plotting _Mission_ outputs
The data generated by the simulation can be visualized ina variety of ways, which will be discussed now.
...
The following plots can also be generated using [example2.py](./example2.py).
